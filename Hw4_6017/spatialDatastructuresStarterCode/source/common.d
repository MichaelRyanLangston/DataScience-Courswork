...
//return the point in an AABB closest to p
...
unittest{
    ...
    //"right half" has the point with x coordinate greater than 2
...
unittest{
    writeln("partitionByDimensionTesting");
    auto points = [Point!2([1,2]), Point!2([3,1]), Point!2([2,3])];
...
unittest{
    writeln("Priority Queue Testing");
    auto points = [Point!2([1,2]), Point!2([3,1]), Point!2([2,3])];
